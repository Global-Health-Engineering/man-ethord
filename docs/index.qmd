...
The following visualization shows how projects are distributed across institutions and project categories.
...
The following visualization shows a more detailed hierarchical breakdown of budget allocation across categories and subcategories.

```{r}
#| label: fig-budget-hierarchy
#| fig-cap: "Budget Distribution by Category and Subcategory"
#| fig-width: 10
#| fig-height: 6
...
budget_table_data |>
  ...
  tab_header(
    ...
    subtitle = "Data of 78/95 projects"
  ) |>
  cols_label(
